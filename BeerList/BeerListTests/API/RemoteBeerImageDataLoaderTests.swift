...
class RemoteBeerImageDataLoader {
    ...
    private struct HTTPTaskWrapper: BeerImageDataLoaderTask {
...
class RemoteBeerImageDataLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteBeerImageDataLoader, toCompleteWith expectedResult: BeerImageDataLoader.Result, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
        let url = URL(string: "https://a-given-url.com")!
        ...
        sut.loadImageData(from: url) { receivedResult in
            ...
            case let (.failure(receivedError as RemoteBeerImageDataLoader.Error), .failure(expectedError as RemoteBeerImageDataLoader.Error)):

...
class BeerListSnapshotTests: XCTestCase {
    ...
    func test_emptyBeerList() {
        ...
        assert(snapshot: sut.snapshot(), named: "EMPTY_BEER_LIST")
    }
    ...
    func test_beerListWithContent() {
        ...
        assert(snapshot: sut.snapshot(), named: "BEER_LIST_WITH_CONTENT")
    }
    ...
    func test_beerListWithErrorMessage() {
        ...
        assert(snapshot: sut.snapshot(), named: "BEER_LIST_WITH_ERROR_MESSAAGE")
    }
    ...
    func test_beerWithFailedImageLoading() {
        ...
        assert(snapshot: sut.snapshot(), named: "BEER_WITH_FAILED_IMAGE_LOADING")
    }
